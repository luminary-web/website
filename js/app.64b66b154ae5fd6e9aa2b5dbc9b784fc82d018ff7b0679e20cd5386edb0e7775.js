...
(() => {
  ...
  `;
    toggleBtn.addEventListener("click", function() {
      ...
      menuIcon.innerHTML = navLinks.classList.contains("show") ? closeSVG : menuSVG;
    });
