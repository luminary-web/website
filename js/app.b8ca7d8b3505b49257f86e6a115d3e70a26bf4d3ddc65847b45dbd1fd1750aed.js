    ...
    const starsHTML = `
      <div class="hero-section-stars">
          <svg width="68" height="665" viewBox="0 0 68 665" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- Add the rest of the stars SVG here -->
          </svg>
      </div>
